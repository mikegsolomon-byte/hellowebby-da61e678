...
const steps = [
  {
    ...
    description: "In your own words, tell us what you do, who your customers are, the look you're after, and any links or examples you love — we'll take it from there."
  },
  {
    number: "2",
    icon: Laptop,
