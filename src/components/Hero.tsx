      ...
      <div className="container relative mx-auto max-w-6xl z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            ...
            <p className="text-lg md:text-xl text-foreground/75 max-w-xl mb-8">
            ...
            {/* Trust bar */}
            <div className="mt-12 rounded-2xl border-2 border-foreground/10 bg-background/60 backdrop-blur px-6 py-4 grid grid-cols-2 gap-4 text-sm font-medium">
              <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-foreground" /> Live in 5 days</div>
              <div className="flex items-center gap-2"><Star className="w-4 h-4 text-foreground" /> 5-star rated by Irish SMBs</div>
              <div className="flex items-center gap-2"><ShieldCheck className="w-4 h-4 text-foreground" /> No long-term contracts</div>
              <div className="flex items-center gap-2"><Phone className="w-4 h-4 text-foreground" /> Local Irish support</div>
            </div>
          </div>

          {/* Right: Image */}
          <div className="relative flex items-center justify-center">
            <div className="relative w-full max-w-md lg:max-w-lg animate-float-slow">
              <img
                src={heroIllustration}
                alt="Professional website being built for your small business"
                className="w-full h-auto rounded-2xl border-2 border-foreground shadow-[8px_8px_0_0_hsl(var(--foreground))]"
                width={1024}
                height={1024}
              />
            </div>
